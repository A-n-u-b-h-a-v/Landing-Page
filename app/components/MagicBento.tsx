            ...
            if (enableStars) {
              return (
                ...
                <a href={card.href} target="_blank" rel="noopener noreferrer" className="block">
                  <div  className="card__header flex justify-between gap-3 relative font-semibold text-black">
                    <span className="card__label text-base font-semibold">{card.label}</span>
                  </div>
                  <div className="card__content flex flex-col font-bold relative text-black">
                    <h3
                      className={`card__title font-normal text-black text-base m-0 mb-1 ${textAutoHide ? "text-clamp-1" : ""}`}
                    >
                      {card.title}
                    </h3>
                    <p
                      className={`card__description text-black text-xs leading-5 opacity-90 ${textAutoHide ? "text-clamp-2" : ""}`}
                    >
                      {card.description}
                    </p>
                  </div>
